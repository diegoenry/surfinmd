!by dgomes para Valiente Wed May  5 20:21:50 BRT 2010
!aumentei o numero de atomos para o sistema do valiente funcionar
***************************************************
...
c MAXNBR parameter should have the same value in the putpnt subroutine
      ...
      parameter (MAXNBR=50000) ! changed from 10000 for big structures ! by debg 29Jul2009
      parameter (MAXSUB=50000) ! changed from 10000 for big structures ! by debg 29Jul2009
      parameter (MAXPRB=50000) ! changed from 10000 for big structures ! by debg 29Jul2009
      parameter (MAXLOW=50000) ! changed from 10000 for big structures ! by debg 29Jul2009
...
140   continue
      ...
      do 160 k = 1,3
      tij(k) = 0.5 * (atoms(k,i1) + atoms(k,i2)) + 0.5 * asymm * uij(k)
160   continue
...
c MAXNBR should have the same value here and in the mds subroutine
      integer MAXNBR
!Wed May  5 20:21:50 BRT 2010
!mudei de 20000 para 50000 para o Valiente
      parameter (MAXNBR=50000) ! FIXED Mon Feb 22 18:58:44 BRT 2010 (devia ter changed from 10000 for big structures ! by debg 29Jul2009)
