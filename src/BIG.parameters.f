...
! parametros
        ...
        parameter (maxamn=3000)
!!! removido v1.05r4        parameter (maxframes=100000)
        character pdbin*30,pdbref*30,out*30,rout*30
...
!!! removido v1.05r4        real desvio(maxframes,maxamn)
!!! removido v1.05r4        real dp(maxamn)
        real tmp
